    ...
    def fit(self, interactions, verbose=False):
        ...
        for epoch_num in range(self._n_iter):
            ...
            for (minibatch_num,
                ...
                self.tr_writer.add_scalar("minbatch loss", loss, global_step=self.counter)
            ...
            if verbose:
                self.tr_writer.add_scalar("epoch loss", epoch_loss, global_step=epoch_num)
